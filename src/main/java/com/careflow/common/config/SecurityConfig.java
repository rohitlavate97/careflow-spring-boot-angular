...
import com.careflow.common.filter.JwtAuthenticationFilter;
...
/**
 * Spring Security Core Configuration (§44).
 * Enforces stateless JWT authentication, CORS for Angular, custom entrypoints, and public endpoint routing.
 */
@Configuration
@EnableWebSecurity
